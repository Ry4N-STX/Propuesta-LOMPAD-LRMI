 ...
 * @author I7 MAX
 */
public class MultipleCheckAccesibilityControl extends FormContainer{
    boolean isOneLine;
    String titleLocal;
    boolean isLineLocal;
    
    public MultipleCheckAccesibilityControl(String title, boolean isLine, boolean isMultiple, boolean isOneLine, String titleLocal, boolean isLineLocal) {
    ...
    void addFormContent() {
        ...
        MultipleCheckAccesibilityControlContainer c2 = new MultipleCheckAccesibilityControlContainer("10.4.1", false, false, isOneLine);
        c2.addFormContent();
