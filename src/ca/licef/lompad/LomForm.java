...
class LomForm extends JPanel {
    ...
    ///////////////////////////////////////////////
    JPanel jPanelOngletAccesibiliti = new JPanel();
    JScrollPane jScrollPaneAccesibiliti = new JScrollPane();
    JPanel jPanelAccesibiliti = new JPanel();
    ///////////////////////////////////////////////
    ...
    public LomForm() {
        ...
        /////////////////////////////////////////////////////////////
        //jPanelAccesibiliti.setLayout(new BorderLayout(0, 0));
        //jTabbedPaneLom.add(jPanelAccesibiliti);
        //jPanelAccesibiliti.setBackground(bgColor);
        
        jPanelOngletAccesibiliti.setLayout(new BorderLayout(0, 0));
        jTabbedPaneLom.add(jPanelOngletAccesibiliti);
        jPanelOngletAccesibiliti.add(BorderLayout.CENTER, jScrollPaneAccesibiliti);
        jPanelAccesibiliti.setAlignmentX(0.0F);
        jPanelAccesibiliti.setLayout(new BoxLayout(jPanelAccesibiliti, BoxLayout.Y_AXIS));
        jScrollPaneAccesibiliti.getViewport().add(jPanelAccesibiliti);
        jPanelAccesibiliti.setBackground(bgColor);
    ...
    ///////////////////////////////
    void initAccesibiliti() {
        AccesibilityForm accesibi = new AccesibilityForm("", true);
        accesibi.addFormContent();
        jPanelAccesibiliti.add(accesibi);
        vComponents.addElement(accesibi);
    }
    //////////////////////////////
