 ...
 * @author I7 MAX
 */
public class MultipleCheckAPI extends FormContainer{
    boolean isOneLine;
    String titleLocal;
    boolean isLineLocal;
    
    public MultipleCheckAPI(String title, boolean isLine, boolean isMultiple, boolean isOneLine, String titleLocal, boolean isLineLocal) {
     ...
     void addFormContent() {
        ...
        MultipleCheckAPIContainer c2 = new MultipleCheckAPIContainer("10.5.1", false, false, isOneLine);
        c2.addFormContent();
