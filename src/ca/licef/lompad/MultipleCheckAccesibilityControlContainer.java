 ...
 * @author I7 MAX
 */
public class MultipleCheckAccesibilityControlContainer extends TextForm{
    ...
    public MultipleCheckAccesibilityControlContainer(String title, boolean isLine, boolean isMultipleContainer, boolean isOneLine) {
        super(title, isLine, isMultipleContainer, isOneLine);
        mediator = new LangstringMediator(this, values);
    }
    
    void addFormContent() {
        MultipleCheckAccesibilityControlComponent date = new MultipleCheckAccesibilityControlComponent();
        date.setMinimumSize(new Dimension(10, 92));
        date.setPreferredSize(new Dimension(10, 92));
        date.setMaximumSize(new Dimension(1000, 92));
        addComponent(date);
    }
